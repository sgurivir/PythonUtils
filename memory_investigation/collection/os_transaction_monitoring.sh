...
do
	...
	dirty_size=`vmmap --summary locationd | grep -A 8 DefaultMallocZone_ | grep TOTAL  | awk '{ print $4}'`
	bytes_allocated=`vmmap --summary locationd | grep -A 8 DefaultMallocZone_ | grep TOTAL  | awk '{ print $7}'`
	allocation_count=`vmmap --summary locationd | grep -A 8 DefaultMallocZone_ | grep TOTAL  | awk '{ print $6}'`
    bytes_lost_to_fragmentation=`vmmap --summary locationd | grep -A 8 DefaultMallocZone_ | grep TOTAL  | awk '{ print $8}'`
